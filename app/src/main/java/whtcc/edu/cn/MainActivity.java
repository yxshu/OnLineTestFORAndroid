...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCertificationZ01.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationZ02.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationZ04.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationZ05.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationZ06.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationZ078.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationZ09.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationT01.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationT02.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationT03.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationT06.setOnClickListener(new onMyClickListener());
        ...
        btnCertificationT07.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationCaption.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationCheif_officer.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationThird_officer.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationChief_engineer.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationSecond_engineer.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationForth_engineer.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationSailor.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationMotorman.setOnClickListener(new onMyClickListener());
        ...
        btnQualificationGMDSS.setOnClickListener(new onMyClickListener());
    }
    ...
    class onMyClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(MainActivity.this.getString(R.string.subject), subject);
